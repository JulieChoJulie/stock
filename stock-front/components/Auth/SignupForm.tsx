...
const SignupForm = () => {
    ...
    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-2">
      <FormField
        ...
        render={({ field }) => (
            ...
            <div className="text-center">
              <Input className="w-full" placeholder="Enter Username" {...field} />
              </div>
            </FormControl>
            <FormMessage />
          </FormItem>
      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem className="mx-4">
            ...
            <FormControl>
            <div className="text-center">
              <Input className="w-full" type="password" placeholder="Repeat Password" {...field} />
              </div>
            </FormControl>
            <FormMessage />
          </FormItem>
      ...
      <Button className="mt-2 h-8" type="submit">Sign up</Button>
      </div>    </form>
  </Form>
  )
}
